                ...
                <div class="row">
                    ...
                    <div class="span4">
                        <div class="product">
                            <div class="product-img featured">
                                <div class="picture">
                                    <img src="{{asset('front/images/dummy/featured-products/featured-1.png')}}" alt="" width="518" height="358" />
                    ...
                    <div class="span4">
                        <div class="product">
                            <div class="product-img featured">
                                <div class="picture">
                                    <img src="{{asset('front/images/dummy/featured-products/featured-2.png')}}" alt="" width="518" height="358" />
                                    <div class="img-overlay">
                                        <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                        <a href="#" class="btn buy btn-danger">خرید</a>
                                    </div>
                    ...
                    <div class="span4">
                        <div class="product">
                            <div class="product-img featured">
                                <div class="picture">
                                    <img src="{{asset('front/images/dummy/featured-products/featured-3.png')}}" alt="" width="518" height="358" />
                                    <div class="img-overlay">
                                        <a href="#" class="btn more btn-primary">توضیحات بیشتر</a>
                                        <a href="#" class="btn buy btn-danger">خرید</a>
                                    </div>
