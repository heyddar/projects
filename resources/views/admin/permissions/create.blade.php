...
<div class="container">
 <div class="card card-body">
        ...
        <h2 class="text-primary"> افزودن نقش جدید </h2>
    ...
    <form class="row justify-content-center" action="{{route('admin.role.store')}}" method="post" id="f1">
        ...
        <div class="col-md-3 form-group">
            ...
            <input type="text" name="display_name" value="{{  old('display_name') }}" id="display_name" class="form-control" placeholder="برای نمایش برای دیگران">
        </div>
        <div class="col-md-3 form-group">
            <label for="description"> توضیحات    </label>
            <textarea type="text" name="description" id="description" class="form-control" placeholder="توضیحاتی در مورد این نقش">
                {{old('description')}}
            </textarea>
        </div>
